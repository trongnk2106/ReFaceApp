...
const ContainerAiAvataredReGened = () => {
    ...
    <View style={{ flex: 1 }}>
      <View
        ...
        >
          ...
          {/* <Top title="Source Image" srcImage={{uri:`data:image/png;base64,${resultRegenAiProfile}`}} /> */}
...
export default ContainerAiAvataredReGened;

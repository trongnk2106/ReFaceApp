    ...
    <View style={{ flex: 1 }}>
      <View
        ...
        >
          ...
          <Top title="Source Image" onPress={handleSources} srcImage={imageSrcDeepFake} />
          <Bottom title="Real Face Image" srcImage={imageRealFaceDeepFake} onPress={handleTarget} />
          <View style={
            {

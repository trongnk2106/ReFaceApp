...
import ContainerAiAvataredReGened from '../components/aiavatar/ContainerAiAvataredReGened';

const AiAvatarReGened = () => {
...
export default AiAvatarReGened;

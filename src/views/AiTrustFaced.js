...
import ContainerAiTrustFaced from '../components/aitrustface/ContainerAiTrustFaced';
...
const AiTrustFaced = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.backround, paddingTop }}>
      ...
      <HeaderResult title='AI Trust Face' goto='AiTrustFace' />
